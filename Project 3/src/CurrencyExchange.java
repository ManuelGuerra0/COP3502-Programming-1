 ...
 * Fixes: 1) Added if-statement in lines 155-156 of the deposit method to prevent errors by returning false for an invalid currency type
 * 2) Added if-statement in lines 188-189 of the withdraw method to prevent errors by returning false for invalid input
 * 3) Added switch statement in lines 248-261 of the convertCurrency method to be able to convert from USD to another foreign currency
 * Total: 2 conceptual changes (adding error protection and adding ability to exchange from USD to others)
 */
